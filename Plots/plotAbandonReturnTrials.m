function participant_data = plotAbandonReturnTrials(data_struct, all_fixations, unique_conditions, condition_labels, group_labels, color_map, comparison_results_folder, safe)
