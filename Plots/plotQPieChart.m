function plotQPieChart(data_numeric, group_name, color_map, safe, comparison_results_folder)
...
title(['Overall Response Proportions for ', group_name, ' Group']);

if safe == 1
    set(gcf, 'Units', 'normalized', 'OuterPosition', [0 0 1 1]);
    saveas(gcf, fullfile(comparison_results_folder, strcat('quest_pie_answer_distr_group_', group_name, '.png')));
end
end
