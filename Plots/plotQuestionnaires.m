...
plotADHDnonADHDandDiff('ASRS Results - Part A',...
...
plotADHDnonADHDandDiff('Summed up ASRS Scores',...
    adhd_condition_avgs, adhd_median, adhd_sem, 'ADHD', 'northeast', ...
    nonadhd_condition_avgs, nonAdhd_median, nonAdhd_sem, 'nonADHD', 'northeast', ...
    ids, {'All', 'Part A'}, 'Sum of Scores', group_labels, {'1', '2', '3', '4', '5', '6'}, color_map_other, color_map_individual, ...
