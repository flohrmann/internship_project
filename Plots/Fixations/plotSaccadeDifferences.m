...
plotADHDnonADHDVariance('Search Path Distance Comparison',...
    ...
    ids, condition_labels, 'Distance of Gaze per Trial (pixels)', group_labels, unique_conditions, color_map, color_map_individual, ...
...
plotADHDnonADHDVariance('Saccade Velocity Comparison',...
    ...
    ids, condition_labels, 'Median Saccade Velocity (pixels per second)', group_labels, unique_conditions, color_map, color_map_individual, ...
...
plotADHDnonADHDVariance('Gaze Distance per Second Comparison',...
    ...
    ids, condition_labels, 'Median Distance(pixels per second)', group_labels, unique_conditions, color_map, color_map_individual, ...
