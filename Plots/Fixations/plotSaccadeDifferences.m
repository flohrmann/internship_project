...
plotADHDnonADHDandDiff('Search Path Distance Comparison',...
...
plotADHDnonADHDandDiff('Saccade Velocity Comparison',...
...
plotADHDnonADHDandDiff('Gaze Distance per Second Comparison',...
