function all_fixations = analyseFixationAllWrapper(data, plot_these, dist_threshold, screenXpixels, screenYpixels, safe, folders, subfolder_fixation, comparison_results_folder, fixation_duration)
