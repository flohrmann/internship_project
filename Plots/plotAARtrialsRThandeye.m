...
for which_condition = 1:2
    ...
    plotADHDnonADHDandDiff('Median Abandon Return Trial Rate',...
    ...
    plotADHDnonADHDandDiff('Median RT of Button Press in Arrive Abandon Return Trials',...
        ...
        ids, condition_labels, 'RT (s)', group_labels, unique_conditions, color_map, color_map_individual, ...
    ...
    plotADHDnonADHDandDiff('Time between Gaze arriving at Target and Button Press in non-AAR-Trials',...
        ...
        ids, condition_labels, 'Lapse RT (s)', group_labels, unique_conditions, color_map, color_map_individual, ...
